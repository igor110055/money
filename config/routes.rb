Rails.application.routes.draw do
  ...
  get 'deal_records_mana', to: 'deal_records#index_mana'
  ...
  get 'clear_invest_log', to: 'deal_records#clear_invest_log'
  ...
  get 'set_crypto_as_home', to: 'deal_records#set_crypto_as_home'
  ...
  get 'invest_mana_log', to: 'main#read_auto_invest_mana_log'
  get 'set_auto_invest_form', to: 'main#set_auto_invest_form'
  get 'set_auto_sell_btc_form', to: 'main#set_auto_sell_btc_form'
  get 'set_auto_sell_eth_form', to: 'main#set_auto_sell_eth_form'
  get 'set_auto_buy_mana_form', to: 'main#set_auto_buy_mana_form'
  post 'set_auto_invest_params', to: 'main#set_auto_invest_params'
  post 'set_auto_sell_btc_params', to: 'main#set_auto_sell_btc_params'
  post 'set_auto_sell_eth_params', to: 'main#set_auto_sell_eth_params'
  ...
  get 'buy_fall_list', to: 'main#buy_fall_list'
  ...
  get 'sync_update_asset', to: 'properties#sync_update_asset'
  get 'sync_update_amount', to: 'properties#sync_update_amount'
  get 'sync_create_asset', to: 'properties#sync_create_asset'
  get 'sync_destroy_asset', to: 'properties#sync_destroy_asset'
